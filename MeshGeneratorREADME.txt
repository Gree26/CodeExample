...
have to place specifically what block they wanted. Think of similar to Minecraft in appearance. So this code is the code 
that was associated with generating that mesh. 
